...
const drills = [
  ...
  { type: "fill", topic: "perfecto", prompt: "Esta semana ellos ___ (escribir) muchos mensajes.", answer: "han escrito", hint: "haber ellos + Partizip unregelmäßig" },
  { type: "fill", topic: "perfecto", prompt: "¿Tú alguna vez ___ (estar) en México?", answer: "has estado", hint: "alguna vez passt oft zum perfecto" },
  { type: "fill", topic: "perfecto", prompt: "Últimamente mi amiga ___ (volver) tarde a casa.", answer: "ha vuelto", hint: "volver -> vuelto" },
  { type: "choice", topic: "perfecto", prompt: "Welche Zeit passt zu: todavía no?", answer: "Pretérito perfecto", options: ["Pretérito perfecto", "Pretérito indefinido", "Pretérito imperfecto"] },
  ...
  { type: "fill", topic: "indefinido", prompt: "Anoche nosotros ___ (ver) una película.", answer: "vimos", hint: "ver: vi, viste, vio, vimos..." },
  { type: "fill", topic: "indefinido", prompt: "Hace dos días mis padres ___ (hacer) una excursión.", answer: "hicieron", hint: "hacer -> hic-/hiz-" },
  { type: "fill", topic: "indefinido", prompt: "El verano pasado yo ___ (viajar) a España.", answer: "viajé", hint: "yo-Form auf -é" },
  { type: "choice", topic: "indefinido", prompt: "Welche Zeit passt zu: ayer?", answer: "Pretérito indefinido", options: ["Pretérito indefinido", "Pretérito perfecto", "Pretérito imperfecto"] },
  ...
  { type: "fill", topic: "imperfecto", prompt: "Cuando era pequeño, yo ___ (ver) dibujos animados.", answer: "veía", hint: "ver im imperfecto" },
  { type: "fill", topic: "imperfecto", prompt: "Antes mis abuelos ___ (vivir) en un pueblo.", answer: "vivían", hint: "-er/-ir: -ía, -ías, -ía, -íamos, -íais, -ían" },
  { type: "fill", topic: "imperfecto", prompt: "De niña Ana ___ (jugar) con sus amigos cada tarde.", answer: "jugaba", hint: "Gewohnheit früher -> imperfecto" },
  { type: "choice", topic: "imperfecto", prompt: "Welche Zeit passt zu: cuando era pequeño?", answer: "Pretérito imperfecto", options: ["Pretérito imperfecto", "Pretérito indefinido", "Pretérito perfecto"] },
  ...
  { type: "choice", topic: "desde", prompt: "Ich wohne seit 2020 in Wien.", answer: "Vivo en Viena desde 2020.", options: ["Vivo en Viena desde 2020.", "Vivo en Viena desde hace 2020.", "Vivo en Viena hace 2020."] },
  { type: "choice", topic: "desde", prompt: "Sie ist vor einer Stunde angekommen.", answer: "Llegó hace una hora.", options: ["Llegó hace una hora.", "Llegó desde una hora.", "Llegó desde hace una hora."] },
  { type: "fill", topic: "desde", prompt: "Vivo aquí ___ hace cinco años.", answer: "desde", hint: "seit + Zeitraum = desde hace" },
  { type: "fill", topic: "desde", prompt: "Llegamos ___ dos días.", answer: "hace", hint: "vor + Zeitraum = hace" },
  { type: "choice", topic: "preps", prompt: "Welche Präposition passt? ocuparse ___ la mascota", answer: "de", options: ["de", "en", "con"] },
  { type: "choice", topic: "preps", prompt: "Welche Präposition passt? quedar ___ mis amigos", answer: "con", options: ["con", "de", "a"] },
  { type: "choice", topic: "preps", prompt: "Welche Präposition passt? asistir ___ un curso", answer: "a", options: ["a", "en", "de"] },
  { type: "choice", topic: "preps", prompt: "Welche Präposition passt? inscribirse ___ una actividad", answer: "en", options: ["en", "con", "de"] },
  { type: "fill", topic: "preps", prompt: "Me quejo ___ los deberes.", answer: "de", hint: "quejarse de" },
  { type: "choice", topic: "relativos", prompt: "Madrid es una ciudad ___ me gusta mucho.", answer: "que", options: ["que", "quien", "lo que"] },
  { type: "choice", topic: "relativos", prompt: "No entiendo ___ dices.", answer: "lo que", options: ["lo que", "donde", "quien"] },
  { type: "choice", topic: "relativos", prompt: "La chica con ___ hablo es simpática.", answer: "quien", options: ["quien", "donde", "lo que"] },
  { type: "choice", topic: "relativos", prompt: "El pueblo ___ vivo es pequeño.", answer: "donde", options: ["donde", "quienes", "lo que"] },
  { type: "fill", topic: "relativos", prompt: "Las personas ___ trabajan aquí son amables.", answer: "que", hint: "que passt für Personen und Sachen" },
  ...
  { type: "fill", topic: "imperativo", prompt: "___ (venir, tú) aquí, por favor.", answer: "ven", hint: "venir -> ven" },
  { type: "fill", topic: "imperativo", prompt: "___ (poner, tú) la mesa.", answer: "pon", hint: "poner -> pon" },
  { type: "fill", topic: "imperativo", prompt: "___ (salir, tú) de casa temprano.", answer: "sal", hint: "salir -> sal" },
  { type: "fill", topic: "imperativo", prompt: "Trae + me + lo = ___", answer: "tráemelo", hint: "Pronomen anhängen, Akzent setzen" },
  { type: "choice", topic: "imperativo", prompt: "Welche Form ist richtig? decir im tú-Imperativ", answer: "di", options: ["di", "dice", "dices"] },
];
...
const writingPrompts = [
  ...
  {
    title: "Vergangenheit: Zeitenmix",
    task: "Schreibe 90-120 Wörter über ein Erlebnis. Verwende perfecto für heutige Erfahrungen, indefinido für abgeschlossene Ereignisse und imperfecto für Hintergrundinfos.",
    starters: ["Esta semana he...", "Ayer fui...", "Cuando llegué...", "El tiempo era...", "Al final..."],
  },
  {
    title: "Mein Alltag zu Hause",
    task: "Beschreibe deine Aufgaben im Haushalt und deine Meinung dazu. Verwende mindestens fünf Vokabeln aus Unidad 3 und zwei Präpositionen.",
    starters: ["Entre semana...", "Me ocupo de...", "Tengo que...", "No me gusta...", "Por eso..."],
  },
  {
    title: "Reiseinfo: Land vorstellen",
    task: "Stelle ein spanischsprachiges Land vor. Nenne Hauptstadt, Landschaft, Essen, Sehenswürdigkeiten und warum du dorthin reisen möchtest.",
    starters: ["El país que quiero presentar es...", "La capital es...", "Hay...", "Me gustaría visitar...", "En mi opinión..."],
  },
  {
    title: "Ratschläge mit Imperativ",
    task: "Gib einer Freundin oder einem Freund 6-8 Tipps für eine Prüfung oder Reise. Verwende mehrere Imperative.",
    starters: ["Estudia...", "Haz...", "No olvides...", "Lleva...", "Pregunta por...", "Sé positivo/a."],
  },
];
